    ...
    if ($stmt = $conn->prepare($sql)) {
        ...
        if ($stmt->num_rows > 0) {
            ...
            if (password_verify($password, $hashed_password)) {
                ...
                $_SESSION['user_id'] = $id;
                $_SESSION['user_name'] = $firstname; // Armazene o nome do usuário na sessão
                
                // COOKIE Se o checkbox "Lembrar senha" estiver marcado, armazene a senha no cookie
                if (isset($_POST['remember']) && $_POST['remember'] == "on") {
                    // Define um cookie com a senha criptografada (use um nome seguro e um tempo de expiração adequado)
                    setcookie("remembered_password", $hashed_password, time() + (86400 * 30), "/");
                }
...
<div class="container">
    ...
    <div class="form">
        <form method="POST">
            ...
            <div class="input-box">
                <input type="password" name="password" placeholder="Senha" maxlength="8" required>
            ...
            <div class="remember-forgot">
                ...
                <a href="forgot_password.php"> Esqueceu senha? </a>        
            </div>
